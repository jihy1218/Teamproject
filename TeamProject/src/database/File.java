...
//	필드 : filepath
//	메소드 : save , load
	private static String memberpath ="C:/Users/505/Desktop/TeamProject2/src/database/member.txt";
	private static String vaccinepath ="C:/Users/505/Desktop/TeamProject2/src/database/vaccine.txt";
				...
				for (int i = 0; i < vaccines.length - 1; i++) {
					...
					for(Vaccine temp : AdminController.vaccinList) {
						if(temp.getV_name().equals(vaccine.getV_name())&&
								...
								temp.getV_count()==vaccine.getV_count()) {
							return true;
						}
					}
